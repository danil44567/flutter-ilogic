...
6. **[Работа с API во Flutter](flutter_api.md)** - Руководство по работе с сетевыми запросами, обработке данных и интеграции с внешними сервисами.
...
4. **[Задания по работе с API](task_4.md)** - Набор заданий для практики интеграции с внешними API, включая поиск, отображение данных и обработку ошибок.
